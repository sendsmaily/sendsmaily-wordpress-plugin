...
class Wp_Sendsmaily_Template
{
	...
	public function render(){
		$fileName = BP . DS . $this->_template;
		
		// check for template file
		if(empty($this->_template) or !file_exists($fileName) or !is_readable($fileName)){
			throw new Exception('Could not find template "'.$fileName.'"! Please check for file existance.');
			return false;
		}
